        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown {{ Request()->is('account*') || Request()->is('position*') ? 'active' : '' }}">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-database"></i>Admin</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-user"></i><a href="/account">Account data</a></li>
                            <li><i class="fa fa-crosshairs"></i><a href="/position">Position</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
