...
<div class="card shadow p-3">
    <form action="/admin/profile-aparatur" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group w-50">
            ...
            <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="nama aparatur" autofocus>
            @error('name')
        ...
        <div class="form-group w-50">
            ...
            <input name="kedudukan" type="text" class="form-control @error('kedudukan') is-invalid @enderror" placeholder="kedudukan" autofocus>
            @error('kedudukan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="form-group w-50">
            ...
            <input name="tugas" type="text" class="form-control @error('tugas') is-invalid @enderror" placeholder="tugas" autofocus>
            @error('tugas')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="form-group w-50">
            ...
            <input name="fungsi" type="text" class="form-control @error('fungsi') is-invalid @enderror" placeholder="fungsi" autofocus>
            @error('fungsi')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
        ...
        <div class="form-group w-50">
            ...
            <input name="keterangan" type="text" class="form-control @error('keterangan') is-invalid @enderror" placeholder="keterangan" autofocus>
            @error('keterangan')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
